...
@Component({
  selector: 'app-immigrant-list',
  templateUrl: './immigrant-list.component.html',
  styleUrls: ['./immigrant-list.component.scss'],
  providers: [DialogService]
})
export class ImmigrantListComponent implements OnInit {
  ...
  displayColumns: string[] = ['DateCreated','TokenNo','PassportNo','Name','PhoneNo','DistrictName','Gender','LastLocation','PortAction', 'Actions'];

...
@Component({
  selector: 'app-quarantine-refer',
  templateUrl: './quarantine-refer.component.html',
  styleUrls: ['./quarantine-refer.component.scss']
})
export class QuarantineReferComponent implements OnInit {
...
changeAction(val){
  ...
  saveData(){
    ...
    this.immigrantService.update_refer_quarantine(this.model).subscribe(
      (data: any) => {
